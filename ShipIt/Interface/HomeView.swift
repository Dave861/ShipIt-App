        ...
        .refreshable {
            for package in packages {
                ...
                if package.courier == "DHL" {
                    ...
                    Task(priority: .high) {
                        do {
                            try await OrderManager(contextMOC: moc).getDPDOrderAsync(package: package, isBackgroundThread: false)
                            do {
                                try moc.save()
                            } catch let err {
                                print(err)
                    ...
                    Task(priority: .high) {
                        do {
                            try await OrderManager(contextMOC: moc).getFanCourierOrderAsync(package: package)
                            do {
                                try moc.save()
                            } catch let err {
                                print(err)
